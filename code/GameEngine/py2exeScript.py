...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "Procedural Generation"
        ...
        #Auhor of program
        self.author_name = "Elizabeth Matthews"
        self.author_email = "ematth2@g.clemson.com"
        self.copyright = "Copyright (c) 2013 Elizabeth Matthews."
 
        #Description
        self.project_description = "Small app to test the procedural generation."
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['sprites', 'tiles', 'maps']
